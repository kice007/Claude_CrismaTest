...
```bash
TRANSITION=$(node "C:/Users/chris/Downloads/Projects/CrismaTech/CrismTest/crismatest/.claude/get-shit-done/bin/gsd-tools.cjs" phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node "C:/Users/chris/Downloads/Projects/CrismaTech/CrismTest/crismatest/.claude/get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
...
```bash
node "C:/Users/chris/Downloads/Projects/CrismaTech/CrismTest/crismatest/.claude/get-shit-done/bin/gsd-tools.cjs" config-set workflow._auto_chain_active false
```
